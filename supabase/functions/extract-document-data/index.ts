    ...
    const response = await fetch('https://ai.gateway.lovable.dev/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: `אתה מומחה לחילוץ נתונים מתמונות של מסמכים עסקיים ישראליים.
חלץ את כל הנתונים שתמצא בתמונה מבין הרשימה הבאה:
...
- חפש בכל המסמך - לרוב המידע מופיע בכותרת, בתחתית או בפינות.
- שים לב לפורמטים ישראליים: ח.פ בדרך כלל 9 ספרות, נייד מתחיל ב-05, טלפון קווי בדרך כלל מתחיל ב-0.`
          },
          {
            ...
            content: [
              {
                type: 'text',
                text: `חלץ את כל הנתונים העסקיים שתמצא בתמונה הבאה (סוג מסמך: ${documentType}):`
              },
              {
                type: 'image_url',
                image_url: {
