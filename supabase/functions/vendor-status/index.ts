...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Fetching vendor status for token:', token);
    ...
    console.log('Found vendor request:', data.vendor_name, 'status:', data.status);
    ...
    console.error('Error in vendor-status:', error);
    return new Response(
