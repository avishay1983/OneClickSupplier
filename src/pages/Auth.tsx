...
const BrandedPanel = () => (
  <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary via-primary/90 to-primary/80 relative overflow-hidden">
    <div className="absolute inset-0">
      ...
      <div
        className="absolute top-1/2 right-1/3 w-64 h-64 bg-accent/20 rounded-full blur-2xl animate-pulse"
    ...
    <div className="relative z-10 flex flex-col justify-between p-12 text-white w-full">
      <div>
        <img src="/images/bituach-yashir-logo.png" alt="ביטוח ישיר" className="h-14" />
      </div>

      <div className="space-y-8">
        <div className="space-y-4">
          <h1 className="text-4xl font-bold leading-tight">ספק בקליק</h1>
      ...
      <div className="text-white/60 text-sm">© 2025 ביטוח ישיר. כל הזכויות שמורות.</div>
    </div>
  </div>
);
...
const FormContainer = ({
  ...
  <div
    className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-12 bg-gradient-to-br from-background via-background to-muted/30"
    dir="rtl"
  >
    <div className="w-full max-w-md">
      <div className="lg:hidden mb-8 text-center">
        <img src="/images/bituach-yashir-logo.png" alt="ביטוח ישיר" className="h-12 mx-auto mb-4" />
      </div>
